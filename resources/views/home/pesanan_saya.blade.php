						...
						@foreach ($pesanan as $item)
							<tr>
								...
								<td>
									<div class="row">
										<div class="col-12">
											<a href="{{ route('pesanan_saya.invoice', ['id' => $item->order_number]) }}" id="pay-button"
												class="btn btn-xs btn-success"><i class="fa fa-file-invoice"></i> Invoice dan Pembayaran</a>
										</div>
										@if ($item->status === 'unpaid')
											<div class="col-12 my-2">
												<button class="btn btn-xs btn-danger" data-mdb-toggle="modal"
													data-mdb-target="#modalBatal{{ $item->id }}"><i class="fa fa-trash"></i> Batal</button>
											</div>
										@endif
									</div>
								</td>
